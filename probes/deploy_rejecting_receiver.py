...
CONTRACT = HERE / "rejecting_receiver.py"
...
def main() -> int:
    if os.environ.get("L4B_ARM_DEPLOY") != "YES":
        print("READ-ONLY: set L4B_ARM_DEPLOY=YES to deploy RejectingReceiver.")
        return 0
    ...
    print("Submitting RejectingReceiver deployment...")
    ...
    out = RESULTS / "l4b-rejecting-receiver.json"
    out.write_text(
        json.dumps(
            {
    ...
    print()
    print("RejectingReceiver address =", address)
    print("Evidence =", out)
